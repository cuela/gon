        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::select('clasificador_id', $lista, null,['class'=>'form-control']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                                    ...
                                    @else
                                        ...
                                        <?php  
                                            ...
                                            foreach ($modulos as $modulo) {
                                                ...
                                                echo "<tr><th width='175'>$modulo->nombre:</th>";
                                                foreach($permisos as $permiso){
                                                    $registro = '<input type="checkbox" value="'.$modulo->id.'_'.$permiso->id.'_'.$role->id.'" name="assignacionPermiso[]" id="permiso-'.$permiso->id.'">'.$permiso->display_name;
                                                    echo "<td>$registro</td>";
                                                }
                                                echo "</tr>";
                                            }
