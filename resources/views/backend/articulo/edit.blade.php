...
@section ('title', 'Administración de Artículos | Editar')
...
@if (access()->hasAccion('editar-contenido-transparencia'))
    {{ Form::model($articulo, ['route' => ['admin.transparencia.articulo.update', $articulo], 'class' => 'form-horizontal', 'articulo' => 'form', 'method' => 'PATCH', 'id' => 'editar-articulo','files'=>true]) }}
