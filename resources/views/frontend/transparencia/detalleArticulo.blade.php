...
<ol class="breadcrumb breadcrumb2">
  ...
  <li><a  href="{{route('frontend.transparenciaArticulo', ['gestionId'=>$gestion->id, 'grupoId'=>$categoria->id,])}}">Lista Artículos</a></li>
  <li class="active">Detalle: {{$articulo->titulo}}</li>  
</ol>
          ...
          <div class="row">
            <h3>{{$articulo->titulo}}</h3>
              ...
              @endif()
                 ...
                 <em>{{$articulo->resumen}}</em>
             <article style="padding: 5px">{!!$articulo->cuerpo!!}</article>
             <div class="clearfix"></div>
             <hr>
          </div>
          @else
